...
contract NftyHalloween is ERC721, Pausable, Ownable, RandomlyAssigned, ERC721CustomEnumerable {
	...
	function supportsInterface(bytes4 interfaceId) public view override(ERC721, ERC721CustomEnumerable) returns (bool) {
